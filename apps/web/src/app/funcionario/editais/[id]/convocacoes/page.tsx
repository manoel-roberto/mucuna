                    ...
                    {colCandidatos.map(c => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {(alertNode || hasPendency || col.id === 'DESCLASSIFICADOS' || col.id === 'CONVOCACAO_ENVIADA') && (
                            <div className="mt-4 pt-4 border-t border-slate-50 flex flex-col gap-2">
                              ...
                              {col.id === 'CONVOCACAO_ENVIADA' && (
                                <button 
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleDrop(null as any, 'AGUARDANDO_DOCUMENTACAO', c.id);
                                  }}
                                  className="w-full mt-2 py-2.5 bg-indigo-600 text-white text-sm font-black uppercase tracking-widest rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 flex items-center justify-center gap-2"
                                >
                                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                  Pedir Documentos
                                </button>
                              )}
                              {hasPendency && (
