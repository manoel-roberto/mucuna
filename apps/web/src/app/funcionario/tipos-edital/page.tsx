  ...
  return (
    <PermissionGuard requiredPermission="TIPOS_EDITAL_LISTAR">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Tipos de Edital</h1>
          <p className="text-slate-500 font-medium">Cadastre finalidades de edital (Ex: Inscrição, Retificação, Resultado)</p>
        </div>
        <button 
      ...
      {showModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 z-[100] animate-in fade-in duration-300">
          <div className="bg-white rounded-[40px] shadow-2xl max-w-lg w-full p-10 space-y-6">
            <h2 className="text-2xl font-black text-slate-900 italic">{formData.id ? 'Editar' : 'Novo'} Tipo</h2>
