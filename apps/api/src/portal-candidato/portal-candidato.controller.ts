import { Controller, Get, Post, Query, Body, UseInterceptors, UploadedFiles, HttpException, HttpStatus, UseGuards, Param, Patch, Request } from '@nestjs/common';
...
export class PortalCandidatoController {
  constructor(private readonly portalCandidatoService: PortalCandidatoService) {}
  ...
  async getStatus(
    ...
    if (!cpf || !inscricao) {
      throw new HttpException('CPF e Inscrição são obrigatórios.', HttpStatus.BAD_REQUEST);
    }
